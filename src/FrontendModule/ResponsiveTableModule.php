...
namespace Rwd\ResponsiveTablesBundle\ContentElements;
 ...
 */
class ContentResponsiveTable extends ContentElement
{
	/**
	 * Template
	 * @var string
	 */
	protected $strTemplate = 'ce_tableResponsive';
...
class_alias(ContentResponsiveTable::class, 'ContentResponsiveTable');